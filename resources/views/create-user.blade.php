    ...
    <div class="p-3">
        ...
        <form class="row g-3" action="{{ route('load.user') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="contact_num_one" id="contact_num_one" value="{{old('contact_num_one')}}">
            </div>

            <div class="col-md-6">
                <label for="connumtwo" class="form-label">Contact Number two</label>
                <input type="text" class="form-control" name="contact_num_two" id="connumtwo" value="{{old('contact_num_two')}}">
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="date" class="form-control" name="hiring_date" id="hiringdate" value="{{old('hiring_date')}}">
            </div>
            ...
            <div class="col-12">
                ...
                <input type="file" class="form-control" name="profile_picture" id="avatar" value="">
            </div>
