...
@section('content')
            ...
            <form class="row g-3" action="{{ route('update.user' , $user->id) }}" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="contact_num_one" id="contact_num_one" value="{{ $user->contact_num_one }}">
                  </div>

                  <div class="col-md-6">
                    <label for="connumtwo" class="form-label">Contact Number two</label>
                    <input type="text" class="form-control" name="contact_num_two" id="connumtwo" value="{{ $user->contact_num_two }}">
                  </div>
